...
_observatory_horizon   = 5     # If Sun is below this altitude, the program will take data
...
_local_timezone     = +7     # UTC+1
_computer_timezone  = +7     # UTC
...
daily_graph_directory = monthly_data_directory+"/grafik/"
